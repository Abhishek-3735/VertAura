...
const Button = () => {
  return (
    <div className="relative flex items-center justify-center p-4">
      <a
        href="#"
        className="text-lg sm:text-3xl md:text-4xl lg:text-5xl font-bold pb-5 text-transparent bg-gradient-to-r from-gray-500 via-white to-gray-500 bg-clip-text
